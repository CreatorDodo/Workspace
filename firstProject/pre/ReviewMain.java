...
public class ReviewMain {
	...
	public void reviewAdmin() {
		...
		case 2 :
			...
			break;
		case 3 :
//			new MemberMain().adminMenu(); 원래는 관리자로 가야 맞음
			reviewAdmin(); //일단은 리뷰관리 페이지로 넘어가게 만듦
			break;
		default:
	...
	// 리뷰 관리 -- 관리자 메뉴에서 + 정렬
	public void reviewAdmin(String sort) {
		System.out.println("============리뷰 관리===========");
	...
	// 리뷰 파트 --> 영화 자세히 보기에서
	public void reviewMember(int movieNo) {
		...
		System.out.println("-----------------------------");
		System.out.println("1.리뷰 더보기   2.리뷰 정렬하기    3.이전으로"); 
...
//			new MovieMain().adminMenu(); // 관심영화 메소드 호출
	...
	// 리뷰 파트 --> 영화 자세히 보기에서
	public void reviewMember(int movieNo, String sort) {
		System.out.println("============이 작품의 리뷰 목록===========");
		...
		case 2 :
			...
			break;
		case 3 :
//			new MemberMain().adminMenu(); //얘도 관리자 페이지로 가는게 맞음
			reviewAdmin();//일단은 영화관리 페이지로
			break;
		case 4 :
//			new MovieMain().adminMenu(); // 관심영화 메소드 호출
			break;
	...
	// 리뷰 자세히 보기
	public void reviewDetail(int reviewNo) {
		...
		if (rvo == null) {
			...
			case 3:
//				movieMain.movieDetail(movieNo); 원래 영화 자세히 보기로 가는게 맞음
				reviewMember(movieNo);// 디버깅 할때 편하게 리뷰 목록으로 가겠음.
				break;
			}
...
//	public void myReview() {}
	...
	// 리뷰 쓰기
	public void reviewadd(int movieNo) {
