...
<body>
	...
	<div class="container">
		<div class="text-center">
			...
			<form action="j_security_check" id="frm">
				<h3>LOGIN</h3>
				<br>
				<!-- 로그인 실패 메시지 출력 -->
				<c:if test="${param.msg == 'loginFail'}">
					<div class="alert alert-danger text-center">아이디 또는 비밀번호가 일치하지 않습니다.</div>
				</c:if>
				<!-- END 로그인 실패 메시지 출력 -->	
				<div style="padding-left: 250px;" class="form-group row">
					...
					<div class="col-sm-5">
						<input type="text" name="j_username" id="ide" class="form-control"
				...
				<div style="padding-left: 250px;" class="form-group row">
					...
					<div class="col-sm-5">
						<input type="password" name="j_password" id="pwe" class="form-control"
