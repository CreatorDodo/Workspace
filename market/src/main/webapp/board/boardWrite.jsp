...
<body>
	...
	<div class="container">
		...
		<form action="/market/BoardWrite.do" method="post" id="frm" name="regFrm">
			<div class="form-group row">
				<label class="col-sm-2">아이디</label>
				<div class="col-sm-3">
					<input type="text" name="userid" id="userid"
						class="form-control" value="${sid }" readonly="readonly">
				</div>
			...
			<div class="form-group row">
				...
				<textarea name="content"
						id="content" class="form-control" rows="5" cols="5" required></textarea>
